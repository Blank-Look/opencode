...
2. Follow the [Incident Response Process](https://blank-look.github.io/opencode/products/knowledgebase/docs/security/incident-response.html) in the ICT Knowledge Base
