...
> **Product landing pages:** [AI-Assisted Delivery Lifecycle](https://blank-look.github.io/opencode/sdlc/) · [Stage Gates](docs/governance/stage-gates.html) · [Project Sizing](docs/governance/project-sizing.html) · [Scaled Documentation](docs/governance/scaled-documentation.html)
