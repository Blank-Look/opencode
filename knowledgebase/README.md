...
> **Product landing pages:** [ICT Knowledge Base](https://blank-look.github.io/opencode/knowledgebase/)
...
The site is pure HTML/CSS — just push to GitHub. GitHub Pages serves the repo root, so the KB lives at `/knowledgebase/`.
