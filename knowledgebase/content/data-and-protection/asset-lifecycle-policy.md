...
This policy covers the **operational asset lifecycle** — managing applications and data once they are in service. For the **delivery lifecycle** (how technology initiatives are built, tested, and released), see the [AI-Assisted Delivery Lifecycle](https://blank-look.github.io/opencode/development/sdlc/index.html).
